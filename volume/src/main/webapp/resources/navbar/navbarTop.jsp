...
<div class="w3">
  <div class="w3-bar w3-lime w3-card w3-left-align w3-large">
    ...
    <a href="Exchangelist.do" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white" style="z-index:3;width:300px;font-weight:bold;">EXCHANGE</a>
