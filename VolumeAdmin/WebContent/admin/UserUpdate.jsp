...
window.onload=function() {
	$.ajax({
		...
		success: function(data) {
			var str="";
				str+="<tr>";
				str+="<td class='text-center'>아이디&nbsp;&nbsp;</td><td><input type='text' value='"+data.id+"' readonly='readonly' id='id'/></td></tr><tr>";
				str+="<td class='text-center'>이름&nbsp;&nbsp</td><td><input type='text' value='"+data.name+"' id='name'/></td></tr><tr>";
				str+="<td class='text-center'>가입일&nbsp;&nbsp</td><td><input type='text' value='"+data.regidate+"' readonly='readonly' id='regidate'/></td></tr><tr>";
				...
				str+="<td class='text-center'>가입경로&nbsp;&nbsp</td><td><input type='text' value='"+data.userType+"' readonly='readonly' id='userType'/></td>";
				str+="</tr>";
			$("#ajaxTable").html(str)
		},
		error: function(e) {
...
<div id="wrap">
    <br>
    <b><font size="5" color="gray">유저 정보 변경하기</font></b>
    <hr size="1" width="550">
    <br>
    <div id="commentUpdateForm">
        <form name="updateInfo" target="parentForm">        
            ...
            <br><br>
            <button type="button" class="btn btn-success" onclick="checkValue();">정보 수정하기</button>
