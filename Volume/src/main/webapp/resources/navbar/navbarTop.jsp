...
<<<<<<< HEAD
    ...
    <a href="BeforeApproval.do" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white" style="z-index:3;width:300px;font-weight:bold;">PROPOSAL</a>
    <a href="#" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white" style="z-index:3;width:300px;font-weight:bold;">EXCHANGE</a>
...
=======
    ...
    <a href="ProjectController.do" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-black" style="z-index:2;width:340px;font-weight:bold;">PROJECT</a>
    <a href="BeforeApproval.do" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-black" style="z-index:3;width:340px;font-weight:bold;">P-PROPOSE</a>
...
<<<<<<< HEAD
    <a href="BeforeApproval.do" class="w3-bar-item w3-button w3-padding-large">PROPOSAL</a>
