	...
	<div class="card bg-light">
		<article class="card-body mx-auto" style="max-width: 400px;">
			...
			<div class="form-group input-group">
				...
				<input class="form-control" placeholder="이름을입력해주세요" type="text"
			...
			<div class="form-group input-group">
				...
				<input class="form-control" placeholder="이메일을입력해주세요" type="text"
					name="email" id="user_email">
			</div>
			<!-- form-group// -->
			<div class="form-group">
				<button type="button" id=findId class="btn btn-primary btn-block"
					onclick='idFindclick();'>아이디 찾기</button>
