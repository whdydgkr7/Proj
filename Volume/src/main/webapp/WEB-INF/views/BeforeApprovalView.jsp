				...
				<div class="w3-row-padding"
					...
					<div class="w3"
						...
						<div class="w3-panel">
							...
							<table>
								<tr>
									<td>이미지:${beforeApprovalDTO.thumbnail}</td>
								</tr>
								<tr>
									<td>프로젝트이름: ${beforeApprovalDTO.title}</td>
								</tr>
								<tr>
									<td>프로젝트 시작일: ${beforeApprovalDTO.start_date}</td>
								</tr>
								<tr>
									<td>프로젝트 시작일: ${beforeApprovalDTO.end_date}</td>
								</tr>
								<tr>
									<td>프로젝트 설명: ${beforeApprovalDTO.content}</td>
								</tr>
								<tr>
									<td>프로젝트 참여인원:${beforeApprovalDTO.p_limit}</td>
								</tr>
							</table>
			    ...
			    // 정상적으로 검색이 완료됐으면 
			     if (status === daum.maps.services.Status.OK) {
			        ...
			        var infowindow = new daum.maps.InfoWindow({
			            content: '<div style="width:150px;text-align:center;padding:6px 0;">프로젝트 행사위치</div>'
			        });
