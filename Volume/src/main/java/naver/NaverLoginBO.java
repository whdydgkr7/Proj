...
public class NaverLoginBO {
	private final static String CLIENT_ID = "PPV0KH6QD00cOju7EEEu";
	private final static String CLIENT_SECRET = "7gTB65Mw1H";
	private final static String REDIRECT_URI = "http://localhost:8080/Volume/callback";
